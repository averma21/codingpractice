...
public class MinSwaps {
    ...
    public static void main(String[] args) {
        ...
        Verifier.verifyEquals(ms.minimumSwap("xx", "yy"), 1);
        Verifier.verifyEquals(ms.minimumSwap("xy", "xy"), 0);
        Verifier.verifyEquals(ms.minimumSwap("xy", "yx"), 2);
        Verifier.verifyEquals(ms.minimumSwap("xx", "yx"), -1);
        Verifier.verifyEquals(ms.minimumSwap("xxyyxyxyxx", "xyyxyxxxyx"), 4);
    }
